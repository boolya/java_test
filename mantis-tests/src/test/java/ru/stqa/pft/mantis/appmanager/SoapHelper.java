...
public class SoapHelper {
  ...
  public Issue addIssue(Issue issue) throws RemoteException, ServiceException, MalformedURLException {
    ...
    BigInteger issuedId = mc.mc_issue_add(app.getProperty("web.adminLogin"), app.getProperty("web.adminPassword"), issueData);
    IssueData createdIssueData = mc.mc_issue_get(app.getProperty("web.adminLogin"), app.getProperty("web.adminPassword"), issuedId);
    return new Issue()
